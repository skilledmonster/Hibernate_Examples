...
public class HibernateCriteriaAddRestrictionScenarios {
	...
	public static void main(String[] args) {
		...
		System.out.println("Films with Rental duration between 3 and 6");
		System.out.println("<!----------------------------------------------------------------------------------------------->");
		
		for (Film f: results) {
			
			System.out.println(" Duration " + f.getRentalDuration() +  " - Film Title # " + f.getTitle() + " - Cost #  " + f.getRentalRate() ) ;
